...
Another important aspect of increasing concern for both regulators and consumers is the so-called NVH (Noise, Vibration and Harshness) problem that opened this chapter. While in some cases the addition of a turbocharger to a downsized engine can be useful to attenuate noisy exhaust pulsations \cite{peat2006investigation} and improve knocking resistance \cite{lecointe2003downsizing}, it has also been shown \cite{stoffels2003nvh} that at certain operating conditions, a downsized engine will radiate higher noise levels than an equivalent engine of larger displacement.
