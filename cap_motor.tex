%!TEX root = Tesis.tex
\chapter{Validation on real engine conditions\textcolor{red}{[Article expMethod - rewrite]}}
\label{cap:engine}
% Quote
% \null\vspace{-10mm}
% \begin{flushright}
...
A particular feature of this engine test cell is that it allows the use of compressed air injection into the inlet manifold, after the intercooler. More details and schematics about this particular aspect of the setup can be found on \cite{galindo2013engine,galindo2011measurement}. A reservoir is added to smooth out irregularities that could be present in the injected flow. This reservoir can be seen in the bottom-right corner of Fig.~\ref{fig:setup_photo}.
...
\subsection{In-duct and orifice noise}
