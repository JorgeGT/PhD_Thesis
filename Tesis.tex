...
% Colors
%\definecolor{tema}{RGB}{95,95,95} % UPV-like gray
%\definecolor{tema}{rgb}{0,0,0} % Black
%\definecolor{tema}{RGB}{0,50,150} % Blue
...
% Itemize symbols
\renewcommand{\labelitemi}{\scriptsize\raisebox{0.5mm}{\Circsteel}}
\renewcommand{\labelitemii}{\scriptsize\raisebox{0.4mm}{\Squaresteel}}
...
% Chapter
\titleformat{\chapter}[hang]{}{}{0mm}{\large\bfseries\cabincondensed\hspace{0mm}CHAPTER \thechapter\\[-1mm]\Huge}

% Section
\titleformat{\section}[hang]{}{}{0mm}{\bfseries\sffamily\Large\arabic{chapter}.\arabic{section}. }[\vspace{-1mm}]

% Subsection
\titleformat{\subsection}[hang]{}{}{0mm}{\bfseries\large\sffamily\arabic{chapter}.\arabic{section}.\arabic{subsection}. }[\vspace{1mm}]

% Subsubsection
\titleformat{\subsubsection}[hang]{}{}{0mm}{\bfseries\sffamily\arabic{chapter}.\arabic{section}.\arabic{subsection}.\arabic{subsubsection}. }[\vspace{1mm}]

% Main pagestyle
\fancyhf{}
\fancyhead[RO]{\small\cabincondensed\bfseries \rightmark\quad|\quad\thepage}
