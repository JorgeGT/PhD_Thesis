...
Additionally, two manuscripts entitled ``Local flow measurements in a turbocharger compressor inlet'' and ``Measuring turbocharger compressor inlet backflow through laser particle image velocimetry'', to be submitted to journal \emph{Experimental Thermal and Fluid Science}, have been prepared and are under review with industry partner Jaguar Land Rover Limited, which has partially supported their development.
