...
Last but not least, I wish to thank my friends and family for their everlasting support, specially my parents from whom I inherited the appreciation for mathematics and science. And finally, thank you, Paula, for sharing this journey, and those that will come.\\[-1mm]

\hspace{0.7\textwidth}
\begin{minipage}[t]{0.3\textwidth}
\includegraphics[width=5cm]{logos/firma2}\\[-0.5mm]
\centering
\cabin\small Jorge García Tíscar
\end{minipage}
