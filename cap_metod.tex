...
An effort was made during the experimental campaign to allow the measurement of thermodynamic conditions in this region: temperature, pressure and velocity. \textcolor{red}{Comparisons with CFD simulations provided not only validation of the numerical prediction but also further insight as to how the precise geometry of the inlet influenced these conditions.}

\begin{figure}[htb!]
\centering
\includegraphics[width=0.65\textwidth]{figures/cap_metod/locales_sin_brida}
...
% \vspace{-4mm}
% \includegraphics[width=0.45\textwidth]{figures/cap_metod/medidas_locales_corte}
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.5\textwidth]{figures/cap_metod/medidas_locales_corte}
