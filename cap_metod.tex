...
\begin{figure}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/schematic_bw}
...
\begin{figure}[b!]
\centering
\includegraphics[scale=0.80]{figures/cap_metod/setup_t_bw}
\caption[Scheme of the proposed turbocharger instrumentation setup]{Scheme of the proposed turbocharger instrumentation setup, highlighting the three-sensor beamforming arrays and their clearance requirements.}
...
\begin{subappendices}
\begingroup
\titleformat{\section}[hang]{}{}{0mm}{\bfseries\sffamily\Large\arabic{chapter}.\Alph{section}. }[\vspace{-1mm}]
