%!TEX root = Tesis.tex
\chapter{Measurement methodology} \label{cap:metod}
...
\section{In-duct noise measurement \textcolor{red}{[Article expMethod - rewrite]}} % Articulo methodology
...
\begin{figure}[b!]
\centering
\includegraphics[scale=0.78]{figures/cap_metod/setup_t}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/Decomposition_t}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/Spectra}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/6031_calibration_t}
...
\begin{figure}[bth!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/datapoints_surge.pdf}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/gr_mapa_ruido_dB_1000-3000.pdf}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/gr_spec_ruido_dB_50-5000.pdf}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=\textwidth]{figures/cap_metod/mapas_comp}
\caption{Outlet maps computed at different frequency ranges. From left to right: a general view of the plane wave range global intensity; the characteristic band of the ``whoosh noise'', and a narrow low frequency band that indicates surge onset.}
