...
\begin{figure}[htb!]
\includegraphics[width=0.5\textwidth]{figures/cap_inlet/temperatures_rise_line-80-100216.pdf}
\includegraphics[width=0.5\textwidth]{figures/cap_inlet/temperatures_rise_line-100-100216.pdf}
\includegraphics[width=0.5\textwidth]{figures/cap_inlet/temperatures_rise_line-120-100216.pdf}
\includegraphics[width=0.5\textwidth]{figures/cap_inlet/temperatures_rise_line-140-100216.pdf}
\includegraphics[width=0.5\textwidth]{figures/cap_inlet/temperatures_rise_line-160-100216.pdf}
...
\begin{figure}[tb!]
\centering
\includegraphics[width=\textwidth]{figures/cap_inlet/temp_maps}
...
\begin{figure}[tb!]
%\centering
\includegraphics[width=0.98\textwidth]{figures/cap_inlet/probes_in_and_out_line-160-100216}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.65\textwidth]{figures/cap_inlet/intens_maps}
...
% \begin{figure}[b!]
% \centering
% \includegraphics[width=0.93\textwidth]{figures/cap_inlet/profileLong_vel_mov_avg}
% \caption{Velocity magnitude over the centreline of the longitudinal plane at high and low flow. Solid line indicates the mean and points correspond to individual snapshot pairs. Note that distances below 10 mm are obscured by the adaptor piece.}
% \label{fig:line_comp_long}
% \end{figure} 
...
\begin{figure}[thb!]
\centering
\includegraphics[width=1\textwidth]{figures/cap_inlet/profiles_temp_vs_vel}
