...
\blfootnote{Work on this chapter has been partly published in the following papers:
\begin{itemize}
...
\includegraphics[width=1.1\textwidth]{figures/cap_cfd/pressure_fft_walls}
