...
\caption[Image of the CFD domain with different monitors]{Image of the CFD domain, highlighting the compressor wheel and including the three different kind of pressure monitors selected during th setup, at three different sections of the inlet and outlet ducts.}
